...
public static class Predefined
{
    ...
    private static readonly Collections.Dictionary<string, Location> predefinedLocations = new()
    {
        ...
        {"Lever-Estate Elevator Left", new FrogLeverLocation { UniqueId = "crypt_exit1", Area = Area.Estate }},
        {"Lever-Estate Elevator Right", new FrogLeverLocation { UniqueId = "crypt_exit2", Area = Area.Estate }},
