...
public static class Predefined
{
    ...
    private static readonly Collections.Dictionary<string, Item> predefinedItems = new()
    {
        ...
        // Levers
        {"Bomb Exit Lever", new KeyItem { UniqueId = "hod_frog_lever", DisplayName = "Bomb Exit Lever", Icon = "FrogLever" }},
        {"Cemetery Sewer Lever", new KeyItem { UniqueId = "lever_graveyardsummiteast", DisplayName = "Cemetery Sewer Lever", Icon = "FrogLever" }},
        {"Guardian of the Door Access Lever", new KeyItem { UniqueId = "lever_graveyardredeemer", DisplayName = "Guardian of the Door Access Lever", Icon = "FrogLever" }},
        {"Cemetery Shortcut to East Tree Lever", new KeyItem { UniqueId = "lever_graveyardforestroute", DisplayName = "Cemetery Shortcut to East Tree Lever", Icon = "FrogLever" }},
        {"Cemetery East Tree Lever", new KeyItem { UniqueId = "lever_graveyardeast", DisplayName = "Cemetery East Tree Lever", Icon = "FrogLever" }},
        {"Catacombs Tower Lever", new KeyItem { UniqueId = "lever_graveyardcentraltower", DisplayName = "Catacombs Tower Lever", Icon = "FrogLever" }},
        {"Cemetery Exit to Estate Lever", new KeyItem { UniqueId = "lever_graveyardsummitwest", DisplayName = "Cemetery Exit to Estate Lever", Icon = "FrogLever" }},
        {"Catacombs Exit Lever", new KeyItem { UniqueId = "lever_catacombsexit", DisplayName = "Catacombs Exit Lever", Icon = "FrogLever" }},
        {"Hookshot Silent Servant Lever", new KeyItem { UniqueId = "lever_connectcave", DisplayName = "Hookshot Silent Servant Lever", Icon = "FrogLever" }},
        {"Sailor Turncam Upper Lever", new KeyItem { UniqueId = "lever_sailorturncam1", DisplayName = "Sailor Turncam Upper Lever", Icon = "FrogLever" }},
        {"Sailor Turncam Lower Lever", new KeyItem { UniqueId = "lever_sailorturncam2", DisplayName = "Sailor Turncam Lower Lever", Icon = "FrogLever" }},
        {"Sailor Greatsword Gate Lever", new KeyItem { UniqueId = "sailorgate", DisplayName = "Sailor Greatsword Gate Lever", Icon = "FrogLever" }},
        {"Lockstone East Start Shortcut Lever", new KeyItem { UniqueId = "fort_east_start", DisplayName = "Lockstone East Start Shortcut Lever", Icon = "FrogLever" }},
        {"Lockstone Entrance Lever", new KeyItem { UniqueId = "fort_gate_1", DisplayName = "Lockstone Entrance Lever", Icon = "FrogLever" }},
        {"Lockstone East Lower Lever", new KeyItem { UniqueId = "fort_upper1", DisplayName = "Lockstone East Lower Lever", Icon = "FrogLever" }},
        {"Lockstone Upper Shortcut Lever", new KeyItem { UniqueId = "fort_ladlev_2", DisplayName = "Lockstone Upper Shortcut Lever", Icon = "FrogLever" }},
        {"Lockstone Dual Laser Puzzle Lever", new KeyItem { UniqueId = "fort_gate_4", DisplayName = "Lockstone Dual Laser Puzzle Lever", Icon = "FrogLever" }},
        {"Lockstone Tracking Beam Puzzle Lever", new KeyItem { UniqueId = "fort_gate_2", DisplayName = "Lockstone Tracking Beam Puzzle Lever", Icon = "FrogLever" }},
        {"Lockstone Vertical Laser Puzzle Lever", new KeyItem { UniqueId = "fort_gate_3", DisplayName = "Lockstone Vertical Laser Puzzle Lever", Icon = "FrogLever" }},
        {"Lockstone North Puzzle Lever", new KeyItem { UniqueId = "fort_gate_5", DisplayName = "Lockstone North Puzzle Lever", Icon = "FrogLever" }},
        {"Lockstone Secret West Lever", new KeyItem { UniqueId = "lever_fortresssecretwest", DisplayName = "Lockstone Secret West Lever", Icon = "FrogLever" }},
        {"Lockstone Hookshot Puzzle Lever", new KeyItem { UniqueId = "fort_gate_8", DisplayName = "Lockstone Hookshot Puzzle Lever", Icon = "FrogLever" }},
        {"Lockstone Upper Puzzle Lever", new KeyItem { UniqueId = "fort_gate_upper", DisplayName = "Lockstone Upper Puzzle Lever", Icon = "FrogLever" }},
        {"Lockstone Upper Dual Laser Puzzle Lever", new KeyItem { UniqueId = "fort_gate_6", DisplayName = "Lockstone Upper Dual Laser Puzzle Lever", Icon = "FrogLever" }},
        {"Watchtowers Before Ice Arena Lever", new KeyItem { UniqueId = "lever_mountaintopsshortcut2", DisplayName = "Watchtowers Before Ice Arena Lever", Icon = "FrogLever" }},
        {"Watchtowers After Ice Skating Lever", new KeyItem { UniqueId = "lever_mountaintopsshortcut3", DisplayName = "Watchtowers After Ice Skating Lever", Icon = "FrogLever" }},
        {"Watchtowers After Boomers Lever", new KeyItem { UniqueId = "lever_mountaintopsshortcut1", DisplayName = "Watchtowers After Boomers Lever", Icon = "FrogLever" }},
        {"Ruins Settlement Gate Lever", new KeyItem { UniqueId = "forestoldsettlementgate", DisplayName = "Ruins Settlement Gate Lever", Icon = "FrogLever" }},
        {"Ruins Upper Dungeon Entrance Lever", new KeyItem { UniqueId = "colliseumsecret", DisplayName = "Ruins Upper Dungeon Entrance Lever", Icon = "FrogLever" }},
        {"Ruins Ladder Left of Lord of Doors Arena Lever", new KeyItem { UniqueId = "fsettle_sc_1", DisplayName = "Ruins Ladder Left of Lord of Doors Arena Lever", Icon = "FrogLever" }},
        {"Ruins Entrance Ladder Shortcut Lever", new KeyItem { UniqueId = "forest_short1", DisplayName = "Ruins Entrance Ladder Shortcut Lever", Icon = "FrogLever" }},
        {"Ruins Main Gate Lever", new KeyItem { UniqueId = "forest_gate_lever", DisplayName = "Ruins Main Gate Lever", Icon = "FrogLever" }},
        {"Dungeon Entrance Right Gate Lever", new KeyItem { UniqueId = "jail2", DisplayName = "Dungeon Entrance Right Gate Lever", Icon = "FrogLever" }},
        {"Dungeon Entrance Left Gate Lever", new KeyItem { UniqueId = "jail1", DisplayName = "Dungeon Entrance Left Gate Lever", Icon = "FrogLever" }},
        {"Dungeon Above Crow 2 Lever", new KeyItem { UniqueId = "foresteastexit", DisplayName = "Dungeon Above Crow 2 Lever" , Icon = "FrogLever"}},
        {"Fortress Bomb Lever", new KeyItem { UniqueId = "swampladdershortcut2", DisplayName = "Fortress Bomb Lever", Icon = "FrogLever" }},
        {"Fortress Main Gate Lever", new KeyItem { UniqueId = "swamp_enter_maingatelever", DisplayName = "Fortress Main Gate Lever", Icon = "FrogLever" }},
        {"Fortress Central Shortcut Lever", new KeyItem { UniqueId = "swampladdershortcut1", DisplayName = "Fortress Central Shortcut Lever", Icon = "FrogLever" }},
        {"Fortress Statue Lever", new KeyItem { UniqueId = "swampgateshortcut1", DisplayName = "Fortress Statue Lever", Icon = "FrogLever" }},
        {"Fortress Watchtower Lower Lever", new KeyItem { UniqueId = "swampladdershortcut4", DisplayName = "Fortress Watchtower Lower Lever", Icon = "FrogLever" }},
        {"Fortress Bridge Ladder", new KeyItem { UniqueId = "swampladdershortcut3", DisplayName = "Fortress Bridge Ladder", Icon = "FrogLever" }},
        {"Fortress Pre-Main Gate Lever", new KeyItem { UniqueId = "swampgateshortcut2", DisplayName = "Fortress Pre-Main Gate Lever", Icon = "FrogLever" }},
        {"Fortress Watchtower Upper Lever", new KeyItem { UniqueId = "swampladdershortcut5", DisplayName = "Fortress Watchtower Upper Lever", Icon = "FrogLever" }},
        {"Fortress North West Lever", new KeyItem { UniqueId = "lever_swampnorthwest", DisplayName = "Fortress North West Lever", Icon = "FrogLever" }},
        {"Estate Elevator Left Lever", new KeyItem { UniqueId = "crypt_exit1", DisplayName = "Estate Elevator Left Lever", Icon = "FrogLever" }},
        {"Estate Elevator Right Lever", new KeyItem { UniqueId = "crypt_exit2", DisplayName = "Estate Elevator Right Lever", Icon = "FrogLever" }},
        {"Garden of Love Lever", new KeyItem { UniqueId = "lever_gardennorthwest", DisplayName = "Garden of Love Lever", Icon = "FrogLever" }},
        {"Garden of Life End Lever", new KeyItem { UniqueId = "lever_gardennortheast", DisplayName = "Garden of Life End Lever", Icon = "FrogLever" }},
        {"Garden of Peace Lever", new KeyItem { UniqueId = "Garden2End", DisplayName = "Garden of Peace Lever", Icon = "FrogLever" }},
        {"Garden of Joy Lever", new KeyItem { UniqueId = "Garden1End", DisplayName = "Garden of Joy Lever", Icon = "FrogLever" }},
        {"Garden of Love Turncam Lever", new KeyItem { UniqueId = "lever_gardenturncam", DisplayName = "Garden of Love Turncam Lever", Icon = "FrogLever" }},
        {"Garden of Life Lanterns Lever", new KeyItem { UniqueId = "garden4lantern", DisplayName = "Garden of Life Lanterns Lever", Icon = "FrogLever" }},
        {"Estate Underground Urn Shed Lever", new KeyItem { UniqueId = "lever_Gardenselixir", DisplayName = "Estate Underground Urn Shed Lever", Icon = "FrogLever" }},
        {"Manor Big Pot Arena Lever", new KeyItem { UniqueId = "lever_dumbwaiter", DisplayName = "Manor Big Pot Arena Lever", Icon = "FrogLever" }},
        {"Manor Bookshelf Shortcut Lever", new KeyItem { UniqueId = "mansionlibrarylever", DisplayName = "Manor Bookshelf Shortcut Lever", Icon = "FrogLever" }},
